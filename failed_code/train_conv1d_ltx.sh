#!/bin/bash
export MODEL_PATH="Lightricks/LTX-Video"
export DATASET_PATH="data/dance-twirl"
export OUTPUT_PATH="checkpoints/ltx/lr_1e-6_skipconv1d_kernel_3_mid_128_warmup_100_gas_4_logit_normal_mse_1.0_512x768_ltx_dance-twirl"
