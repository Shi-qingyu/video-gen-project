...
class Guidance(nn.Module):
    ...
    def run(self):
        ...
        decoded_frames = tensor2vid(decoded_frames)  # f h w c numpy [0,255]
        # save frames
        ...
        import imageio
        output_path = os.path.join(self.config["output_path"], "result.mp4")
        imageio.mimwrite(output_path, decoded_frames, fps=8, quality=10)
